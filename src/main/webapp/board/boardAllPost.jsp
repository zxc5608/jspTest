...
<body class="hold-transition sidebar-mini">
	...
	<form id="frm" action="${cp }/boardDetail">
				...
				<section class="content">
					<div class="card">
						<div class="card-header with-border">
							...
							<form action="${cp }/RegistBoard" method="get"  >
							...
							<nav aria-label="member list Navigation">
										<ul class="pagination justify-content-center m-0">
											...
											<c:choose>
												...
												<li class="page-item"><a class="page-link" href="${cp }/boardPost?page=${pagination }&pageSize=${pageVo.pageSize}&bor_no=${pageVo.bor_no}"><i class="fas fa-angle-double-right"></i></a></li>
										</ul>
									</nav>

...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="${cp }/board/BoardInfoList" class="brand-link"> <img src="${cp}/resources/images/line.png" class="brand-image img-circle elevation-3" style="opacity: .8"> <span
				...
				<section class="content">
					<div class="card">
						...
						<div style="float: left;" id="filediv">
	                     ...
	                     <div>
	                         <input type="button" id="registBoard" style="float: right;"class="btn btn-primary" value="등록완료"><br>
	                     </div>
						 <!--   <input  class="col-sm-3" type="file" name="file" value=""/> -->

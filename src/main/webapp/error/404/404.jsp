...
<script type="text/javascript" src="${cp}/error/404/js/impromptu/jquery-impromptu.js"></script>
<script type="text/javascript" src="${cp}/error/404/js/jquery-global.js"></script>

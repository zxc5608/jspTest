...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="${cp }/BoardInfoList" class="brand-link"> <img src="./resources/images/line.png" class="brand-image img-circle elevation-3" style="opacity: .8"> <span
			...
			<div class="content-wrapper" style="min-height: 584px;">
				...
				<section class="content">
					<div class="card">
						...
						<form action="${cp }/BoardModify" method="post">
